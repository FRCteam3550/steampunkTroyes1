...
public class Auto4 extends CommandGroup {
    ...
    public Auto4(double angle1, double distance1,double distance2,double distance3) {
        // Add Commands here:
    	...
    	addSequential(new DriveNewDistanceWithEncoderCommand(distance2));//moves forward
