...
public class RobotMap {
    ...
    public static void init() {
        ...
        deplacementrightFrontMotor = new CANTalon(2);
        LiveWindow.addActuator("Deplacement", "rightFrontMotor", deplacementrightFrontMotor);
        
        deplacementleftRearMotor = new CANTalon(3);
