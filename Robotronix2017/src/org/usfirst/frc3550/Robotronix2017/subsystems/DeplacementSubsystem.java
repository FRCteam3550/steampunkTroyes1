...
public class DeplacementSubsystem extends Subsystem {
    ...
    private final VictorSP leftFrontMotor = RobotMap.deplacementleftFrontMotor;
    private final VictorSP rightFrontMotor = RobotMap.deplacementrightFrontMotor;
    private final VictorSP leftRearMotor = RobotMap.deplacementleftRearMotor;
    private final VictorSP rightRearMotor = RobotMap.deplacementrightRearMotor;
