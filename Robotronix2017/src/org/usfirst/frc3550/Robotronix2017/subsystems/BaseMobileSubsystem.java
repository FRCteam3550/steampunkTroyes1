...
public class BaseMobileSubsystem extends Subsystem {
	...
	public static final double SLOWSPEED    = 0.70;  //drive motor slow speed
   ...
   // private final ADXRS450_Gyro gyro2     = RobotMap.gyro2;
    //private final AnalogInput Sonar = RobotMap.forwardSonar;
  ...
  //  }
    ...
    /*public void clearTargetAngle(){
    	...
    	table.putNumberArray("targetDerivation", tempArray);
    }
    
    public double getTargetAngle(){
    	return table.getNumberArray("targetDerivation")[0];
    }*/
   ...
   // public double getNewGyroAngle(){
   	 //	return gyro2.getAngle();
  // }
    ...
    public void clearNewGyroAngle(){
      	// gyro2.reset();
      } 
    
    /*public double getSonarAverageVoltage(){
