...
public class OI {
    ...
    public OI() {
        ...
        button3.whenPressed(new ArmDownCommand()); //to inverse 
        ...
        Button button5 = new JoystickButton(coPilote, 5);
        ...
        button7.whenPressed(new PushGearUpCommand());
        
        Button button8 = new JoystickButton(coPilote, 8);
        button8.whenPressed(new PushGearDownCommand());
