...
import org.usfirst.frc3550.Robotronix2017.commands.auto.FromMiddlePlaceGear;
import org.usfirst.frc3550.Robotronix2017.commands.auto.BreachBaseLine;
...
import org.usfirst.frc3550.Robotronix2017.trigger.*;
...
public class OI {
    ...
    public LastMinMalcolm SlowDrive;
    ...
    public OI() {
		...
		int SLOW_BUTTON = 2;
		int NORMAL_BUTTON = 7;
		int SLOW_INVERSE_BUTTON = 9;
		int NORMAL_INVERSE_BUTTON = 8;
		
        //SlowDrive = new LastMinMalcolm(jPilote,NORMAL_INVERSE_BUTTON , SLOW_BUTTON);
        
        /*while(SlowDrive.get()){
        	new SlowDriveInverseCommand();
        }*/
		...
		//Auto2.whenPressed(new FromMiddlePlaceGear (30,200,100));
        
		Button Auto3 = new JoystickButton(jPilote, 4);
		Auto3.whenPressed(new BreachBaseLine(-100));
       ...
       // button6.whileHeld(new DescendClimberCommand());
        ...
        button7.whenPressed(new LowerGearCollectorCommand());
        
        Button button8 = new JoystickButton(coPilote, 8);
        button8.whenPressed(new RiseGearCollectorCommand());
